...
define(['dojo/_base/declare',
  ...
  function(
    ...
    //jshint unused:false
    /****
    This panel is dockable at right
    ****/
    return declare([BaseWidgetPanel, _TemplatedMixin], {
      baseClass: 'jimu-panel jimu-rdockable-panel',
      ...
      onMinimize: function() {
        ...
        this.position.right = (-1) * this.position.width;
        this.setPosition(this.position);
        this.inherited(arguments);
      },
      ...
      _setPostionWidthAndRight: function(){
